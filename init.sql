...
(6,'&lt;p style=&quot;font-size: large;background-color: yellow;&quot;&gt;This is demo instance of LibreBooking. Do not store any private data. Some features like notification email are not set up. The instance resets every full hour.&lt;/a&gt;&lt;/p&gt;',3,NULL,NULL,1);
